			...
			<c:choose>
				...
				<c:otherwise>
					<img class="profileUserImage img_thumb"
						src="${pageContext.request.contextPath}/MemberUpload/${sellerinfo.userId}${ChannelList.chProfile}"
						width="100" height="100">
				</c:otherwise>
			</c:choose>
		</div>
									...
									<li data-articleuid="xTI_303" class="animation_up"
										...
										style="color: inherit; text-decoration: none;"> <strong
											...
											<div class="post_thumb">
												<img class="img_thumb"
													src="${pageContext.request.contextPath}/contents/${ChannelList.chNum}${c.thumbNail}"
