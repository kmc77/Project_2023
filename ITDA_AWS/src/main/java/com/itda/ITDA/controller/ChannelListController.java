...
public class ChannelListController {
	...
	public String showChannelUpdate(@PathVariable("chnum") int chnum, ModelAndView mv, ChannelList ChannelList,
		...
		if (uploadfile != null && !uploadfile.isEmpty()) {
			...
			String fileDBName = fileDBName(fileName, saveFolder + "/image/MemberUpload/" + principal.getName());
			logger.info("fileDBName = " + fileDBName);

			String userFolder = saveFolder + "/image/MemberUpload/" + principal.getName() + File.separator + fileDBName;
