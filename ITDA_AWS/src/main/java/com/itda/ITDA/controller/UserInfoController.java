...
public class UserInfoController {
	...
	private String fileDBName(String fileName, String saveFolder) {
		...
		logger.info("==============saveFolder1111 ========= " + saveFolder);
		...
		logger.info("==============saveFolder222222 ========= " + saveFolder);
		...
		logger.info("==============saveFolder33333 ========= " + saveFolder);
		// 난수를 구합니다.
		Random r = new Random();
	...
	public String changeProfileProcess( Itda_User user,
		...
		if (uploadfile != null && !uploadfile.isEmpty())
		{
			...
			fileDBName = fileDBName(fileName, saveFolder + "/image/Member/" + id);
			logger.info("fileDBName = " + fileDBName);
			String userFolder = saveFolder + "/image/Member/" + id + File.separator + fileDBName;
